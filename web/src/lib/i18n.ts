...
const TRANSLATIONS_EN = {
  ...
  statsOfflineNeverLoaded: "You're offline — stats aren't available yet. They'll load once you reconnect.",
  statsOfflineStale: "You're offline — these numbers are from your last connection and may not include today yet.",
...
const TRANSLATIONS_ES: Record<TranslationKey, Entry> = {
  ...
  statsOfflineNeverLoaded: "Sin conexión — las estadísticas aún no están disponibles. Se cargarán al reconectar.",
  statsOfflineStale: "Sin conexión — estos números son de tu última conexión y puede que no incluyan el día de hoy.",
  statsHoursSuffix: "h",
