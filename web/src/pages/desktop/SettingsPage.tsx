      ...
      {canView && (
        <section className="settings-section">
          ...
          <p className="settings-section-description">
            The Dashboard flags a continuously open work or break shift once it's been open longer than this many
            hours. A shift is automatically closed at midnight every night (Midnight Cutoff), so this alert exists
            for a shift that's been open unusually long within a single day, not for one spanning multiple days.
          </p>
